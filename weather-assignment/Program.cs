...
using WeatherAssignment.Synchronizers;
...
namespace WeatherAssignment
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IHttpRequest, Http.HttpRequest>();
            builder.Services.AddTransient<ICosmosDatasource,CosmosDatasource>();
